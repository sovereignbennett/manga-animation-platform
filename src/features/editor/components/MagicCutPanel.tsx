...
import { useMagicCut } from "@/features/magic-cut/hooks/useMagicCut";
import { BODY_PART_LABELS } from "@/types/segmentation";
import { cn } from "@/lib/utils";
import type { ImageLayer, Layer } from "@/store/editorStore";
...
export function MagicCutPanel() {
  ...
  const layer = layers.filter(isImageLayer).find((l) => selectedIds.includes(l.id));
