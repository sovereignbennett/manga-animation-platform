import { useEditor, type BlendMode, type ImageLayer, type Layer } from "@/store/editorStore";
...
export function RightInspector() {
  ...
  const layer = project.layers.filter(isImageLayer).find((l) => l.id === selectedIds[0]);
